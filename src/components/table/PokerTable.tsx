    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 felt-bg flex flex-col justify-between p-3 gap-2 min-h-0">
        ...
        <div className="flex gap-2 justify-center flex-wrap">
          {opponents.map(opp => (
            ...
            >
              ...
              {opp.currentBet > 0 && (
                <div className="text-xs text-yellow-400 font-mono">{opp.currentBet.toFixed(1)} BB</div>
              )}
        ...
        <div className="flex flex-col items-center gap-1.5">
          ...
          {hero.currentBet > 0 && (
            <div className="text-xs text-yellow-400 font-mono">{hero.currentBet.toFixed(1)} BB</div>
          )}
